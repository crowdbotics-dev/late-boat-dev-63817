"""
Django settings for late_boat_dev_63817 project.
...
ROOT_URLCONF = 'late_boat_dev_63817.urls'
...
WSGI_APPLICATION = 'late_boat_dev_63817.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_boat_dev_63817 API",
    "DESCRIPTION": "API documentation for late_boat_dev_63817 App",
    "VERSION": "v1",
}
